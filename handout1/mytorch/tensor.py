...
class Tensor:
    ...
    def __init__(self, data, requires_grad=False, is_leaf=True,
        ...
        self.requires_grad = requires_grad  # requires_grad defalut is False
        self.is_leaf = is_leaf  # is_leaf default is True
    ...
    def backward(self):
        ...
        grad_of_outputs = self.copy().fill_(1)
    ...
    def __sub__(self, other):
        return F.Sub.apply(self, other)  # 自己实现
